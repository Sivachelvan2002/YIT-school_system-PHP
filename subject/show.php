...
<div class="show-subject">
	...
	<table border="1" cellpadding="10" cellspacing="4" class="table table-dark table-hover" style="width: 24rem;">
	...
	<div><a href="?section=subject&page=index" class="btn btn-outline-success ">Back</a></div>
